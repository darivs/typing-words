...
public class TypingWords { String[] words;
    ...
    public String declareWord() { String w = new String();
        try { String row = "";
    ...
    public int countLinesInFile(String f) throws FileNotFoundException { int c;
    ...
    public Boolean collidedWord() { Boolean col = true;
        return col;
    }
}
